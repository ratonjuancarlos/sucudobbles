    ...
    <main className="min-h-dvh flex flex-col items-center justify-center px-6 bg-gray-50">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-sm space-y-6 border border-gray-200">
        ...
        <button
          ...
          className="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 font-semibold text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
        >
